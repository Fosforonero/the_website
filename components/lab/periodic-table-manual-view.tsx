    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { title: "Reticolo", body: "Disponibile per gli elementi solidi con struttura cristallina nota. Apre una vista 3D interattiva del reticolo (FCC, BCC, HCP, diamante, cubica semplice) con atomi e legami." },
      ...
      },
      {
        ...
        items: [
          ...
          { title: "Struttura cristallina", body: "Per i solidi mostra la struttura reticolare dominante con un diagramma 3D ruotante. Cliccalo per aprire la vista reticolo nel viewport principale." },
          ...
          { title: "Modello quantistico", body: "Gli orbitali s, p, d, f sono visualizzati con colori diversi (ambra, blu, smeraldo, viola) e con le forme angolari corrette derivate dalle funzioni d'onda idrogeno-simili." },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { title: "Lattice", body: "Available for solid elements with a known crystal structure. Opens an interactive 3D lattice view (FCC, BCC, HCP, diamond, simple cubic) with atoms and bonds." },
      ...
      },
      {
        ...
        items: [
          ...
          { title: "Crystal structure", body: "For solid elements, shows the dominant lattice with a rotating 3D unit cell diagram. Click it to expand into the full interactive lattice viewport." },
          ...
          { title: "Quantum model", body: "s, p, d, f orbitals are shown with distinct colors (amber, blue, emerald, violet) and the correct angular shapes derived from hydrogen-like wave functions." },
