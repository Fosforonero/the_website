    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Da dove esce quel 6M? Vale la pena ricavarlo (le equazioni sono qui sotto). Un'orbita circolare vive in un punto stazionario del potenziale, dV_eff²/dr = 0: questo fissa il momento angolare richiesto a quel raggio, L²_circ = M r²/(r − 3M). Nota che diverge a r = 3M — è il limite fotonico, l'orbita circolare più interna possibile in assoluto. Ma «possibile» non è «stabile»: un'orbita stabile sta sul fondo di una conca, quindi vuole anche d²V_eff²/dr² > 0. Le due richieste si scontrano avvicinandosi al buco, e si toccano — la conca si appiattisce in un flesso — esattamente a r = 6M. Quello è l'ISCO: appena più dentro la conca sparisce, e non resta nulla a trattenere il sasso.",
