    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Il disco. Il loro disco era un modello artistico-volumetrico costruito ad hoc dagli artisti (con texture, spessore, volute), non una simulazione GRMHD; il nostro è una superficie otticamente spessa con emissione di corpo nero reale e flusso di Page–Thorne, testurizzata con turbolenza procedurale. Entrambi sono modelli del gas, non soluzioni magnetoidrodinamiche.",
      ...
      },
      {
        ...
        body: [
          ...
          "Disco a profondità ottica, non a fetta geometrica: elimina il bordo nero e il banding e dà una transizione radiale morbida. Pipeline a 16-bit + dithering: niente terrazzamento a 8-bit sui gradienti lisci. Colore dalla temperatura (corpo nero), non da una palette. Flusso di Page–Thorne, non un gradiente arbitrario. Avanzamento analitico fino alla sfera d'influenza e passo adattivo: spendiamo il budget di passi dove conta (vicino al buco), non nel vuoto.",
