---
title: "Two hidden bugs in the WebGPU black hole port"
excerpt: "From WebGL to WebGPU: an impossible cyan stain and a black disk. Two bugs from a transposed matrix and an opacity set too high — and what they reveal about WGSL."
date: "2026-06-08"
tag: "Dev"
image: "/blog/buco-nero/buco-nero-kerr-disco-accrescimento.jpg"
imageAlt: "Kerr black hole ray-traced in WebGPU: correct version after fixing the transposed matrix and volumetric disk opacity"
draft: false
---

![Kerr black hole ray-traced in WebGPU: correct warm-orange disk after the two bug fixes](/blog/buco-nero/buco-nero-kerr-disco-accrescimento.jpg "WebGPU renderer — after the fixes")
*The WebGPU renderer after both fixes: correct blackbody colour (warm orange, not cyan) and balanced volumetric disk opacity. Render: Fosforonero.*
