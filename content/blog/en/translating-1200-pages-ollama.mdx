...
2. **A translation cache.** Today a copy update re-translates everything. With a hash of the source string as the key, I'd re-translate only what changed, and updates would go from minutes to seconds.
