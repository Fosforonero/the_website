...
date: "2026-06-22"
tag: "Dev"
image: "/blog/ollama/traduzione-locale-ollama-qwen.webp"
imageAlt: "Illustrazione della pipeline di traduzione locale con Ollama: script Python traduci.py con modello qwen, 1.200 pagine tradotte a costo zero per il sito multilingua di FitMesh Sync"
---
...
2. **Una cache delle traduzioni.** Oggi un aggiornamento del copy ritraduce tutto. Con un hash della stringa sorgente come chiave, ritradurrei solo ciò che è cambiato, e gli aggiornamenti passerebbero da minuti a secondi. **Aggiornamento (luglio 2026):** l'ho costruita. È diventata [loctron](/blog/costruire-motore-di-traduzione-weglot), il nostro motore di traduzione con memoria, glossario e una cascata DeepL più Ollama, che ora traduce anche l'app Flutter.
...
Quella cache delle traduzioni che citavo poco sopra, nel frattempo, è cresciuta in un motore vero, con memoria, glossario e più motori, capace di tradurre anche l'app: [perché abbiamo costruito il nostro Weglot](/blog/costruire-motore-di-traduzione-weglot).
