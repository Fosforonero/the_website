...
excerpt: "Una pipeline di traduzione locale — JSON → Python → Ollama (qwen2.5:7b su Apple Silicon) → Next.js — che genera 1.243 pagine SEO multilingua per FitMesh Sync. Costo API: zero. Codice, scelte e limiti reali."
date: "2026-06-22"
tag: "Dev"
---
...
2. **Una cache delle traduzioni.** Oggi un aggiornamento del copy ritraduce tutto. Con un hash della stringa sorgente come chiave, ritradurrei solo ciò che è cambiato — gli aggiornamenti passerebbero da minuti a secondi.
